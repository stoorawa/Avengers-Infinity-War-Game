...
icon = pygame.image.load('images/avengers1.png')
...
playerImg = pygame.image.load('images/ironman1.png')
...
for i in range(num_of_enemies):
    ...
    if i==4:
        enemyImg.append(pygame.image.load('images/thanos.png'))
    
    else:
        enemyImg.append(pygame.image.load('images/hand.png'))
...
bulletImg = pygame.image.load('images/32.png')
bulletX = 0
#Same as player
bulletY = 480
...
enemybulletImg = pygame.image.load('images/bolt.png')
...
while running:
    ...
    for i in range(num_of_enemies):
        ...
        if enemyY[i] > 460:
            ...
            mixer.music.stop()
            explosion_Sound = mixer.Sound('images/Bomb.wav')
            explosion_Sound.play()
            time.sleep(1)
            bullet_Sound = mixer.Sound('images/loss.wav')
            bullet_Sound.play()
            running = False
            game_over()
